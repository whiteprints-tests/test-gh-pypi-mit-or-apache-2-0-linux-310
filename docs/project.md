...
The project is hosted on [https://github.com/whiteprints-tests/test-gh-pypi-mit-or-apache-2-0-linux-310.git](https://github.com/whiteprints-tests/test-gh-pypi-mit-or-apache-2-0-linux-310.git).
