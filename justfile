...
translation-extract:
    @just pybabel " \
        extract \
            --omit-header \
            --sort-by-file \
            --output 'src/test_gh_pypi_mit_or_apache_2_0_linux_310/locale/base.pot' \
            src \
    "
...
translation-init locale:
    @just pybabel " \
        init \
            --input-file 'src/test_gh_pypi_mit_or_apache_2_0_linux_310/locale/base.pot' \
            --output-dir 'src/test_gh_pypi_mit_or_apache_2_0_linux_310/locale' \
            --locale='{{ locale }}' \
    "
